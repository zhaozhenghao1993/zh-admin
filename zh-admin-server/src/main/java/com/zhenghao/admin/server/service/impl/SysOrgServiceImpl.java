...
import com.zhenghao.admin.server.dao.SysOrgMapper;
import com.zhenghao.admin.server.dao.SysUserMapper;
...
public class SysOrgServiceImpl implements SysOrgService {
    ...
    public Result<Page<SysOrgEntity>> listOrg(Map<String, Object> params) {
        ...
        page.setData(TreeUtils.build(sysOrgMapper.list(query), SystemConstants.TREE_ROOT));
    ...
    public Result<List<TreeVO>> listTree(Map<String, Object> params) {
        ...
        if (params.get("isRoot") != null && "true".equals(params.get("isRoot"))) {
            ...
            listRoot = TreeUtils.build(sysOrgMapper.listTree(), SystemConstants.TREE_ROOT);
        }
