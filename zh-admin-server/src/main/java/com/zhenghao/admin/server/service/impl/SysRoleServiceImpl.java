...
import com.zhenghao.admin.server.dao.SysRoleMapper;
import com.zhenghao.admin.server.dao.SysRoleMenuMapper;
import com.zhenghao.admin.server.dao.SysUserRoleMapper;
...
public class SysRoleServiceImpl implements SysRoleService {
    ...
    public Result batchRemove(Long[] ids) {
        if (Arrays.stream(ids).anyMatch(SystemConstants.SUPER_ADMIN_ROLE::equals)) {
